...
public class Clientes extends Usuarios {
    ...
    public Clientes( ArrayList<CuentaBancaria> cuentaBancaria, String nombres, String apellidos, String direccion, String telefono, String email, int edad,  String CURP, String RFC) {
